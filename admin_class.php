...
Class Action {
    ...
    extract($_POST);
    $attendance_percentage = $this->calculate_attendance_percentage($student_id, $class_subject_id);
    return $attendance_percentage;
}

function calculate_attendance_percentage($student_id, $class_subject_id) {
    // Implement the previously created MySQL function
    $query = $this->db->query("SELECT calculate_attendance_percentage($student_id, $class_subject_id) AS attendance_percentage");
